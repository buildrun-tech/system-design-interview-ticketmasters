...
## Purpose
Define the AWS API Gateway HTTP API v2 that serves as the public internet entry point, proxying all traffic to the internal NLB via VPC Link with transparent header and query parameter forwarding.
