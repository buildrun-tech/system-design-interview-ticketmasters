# vpc-link-integration Specification

## Purpose
Define the API Gateway VPC Link integration connecting the HTTP API v2 to the internal NLB, including the migration from REST API v1 VPC Link to HTTP API v2 VPC Link with security group support.
